  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="group-hover:opacity-100 p-2 hover:bg-zinc-700 rounded-xl transition-all duration-300 hover:text-rose-400"
      >
        <BsTrashFill
          size={20}
          className="text-zinc-500 hover:text-rose-400 transition-colors ease-in-out duration-300"
        />
      </button>
    </div>
  );
